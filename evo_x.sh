...
git clone https://github.com/musivian/device_xiaomi_sunny.git --depth 1 -b evo-x device/xiaomi/sunny
...
# Clone inline kernel
git clone https://github.com/musivian/kernel_xiaomi_sunny.git --depth 1 -b evo-x kernel/xiaomi/sunny
...
# Source mods
git clone https://github.com/musivian/vendor_evolution.git --depth 1 -b vic vendor/lineage
